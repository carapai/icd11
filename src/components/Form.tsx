...
export const DataEntryForm = observer(() => {
  ...
  const valuesChange = (changedValues: any, allValues: any) => {
    ...
    if (
      form.getFieldValue("q7e7FOXKnOf") &&
      form.getFieldValue("q7e7FOXKnOf") >= 120
    ) {
    ...
    if (
      !form.getFieldValue("jY3K6Bv4o9Q") ||
      form.getFieldValue("jY3K6Bv4o9Q") !== "YN01-01"
    ) {
      store.disableValue("UfG52s4YcUt");
    } else {
      store.enableValue("UfG52s4YcUt");
    ...
    if (
      (changedValues.Kk0hmrJPR90 && changedValues.Kk0hmrJPR90 !== "YN01-01") ||
      !form.getFieldValue("Kk0hmrJPR90")
    ) {
      ...
      >
        ...
        <table className="my-2 w-full border-collapse">
          <tbody>
              ...
              <td className="border p-1" colSpan={2}>
                <Form.Item name="ZKBE8Xm9DJG" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.ZKBE8Xm9DJG.disabled
                    }
                  />
                </Form.Item>
              </td>
              ...
              <td className="border p-1">
                ...
                >
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.ZYKmQ9GPOaF.disabled
                    }
                  />
                </Form.Item>
              </td>
              <td className="border p-1">NIN</td>
              <td className="border p-1">
                <Form.Item name="MOstDqSY0gO" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.MOstDqSY0gO.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              <td className="border p-1">Usual Residence (village)</td>
              <td className="border p-1" colSpan={3}>
                <Form.Item name="zwKo51BEayZ" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.zwKo51BEayZ.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              <td className="border p-1">Usual Residence (Parish)</td>
              <td className="border p-1">
                <Form.Item name="bNpMzyShDCX" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.bNpMzyShDCX.disabled
                    }
                  />
                </Form.Item>
              </td>
              <td className="border p-1">Usual Residence (Sub-county)</td>
              <td className="border p-1">
                <Form.Item name="u44XP9fZweA" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.u44XP9fZweA.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              <td className="border p-1">Usual Residence (County)</td>
              <td className="border p-1">
                <Form.Item name="b70okb06FWa" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.b70okb06FWa.disabled
                    }
                  />
                </Form.Item>
              </td>
              <td className="border p-1">Usual Residence (District)</td>
              <td className="border p-1">
                <Form.Item name="t5nTEmlScSt" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.t5nTEmlScSt.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              <td className="border p-1">Occupation</td>
              <td className="border p-1">
                <Form.Item name="dsiwvNQLe5n" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.dsiwvNQLe5n.disabled
                    }
                  />
                </Form.Item>
              </td>
              <td className="border p-1">Date of Birth</td>
              <td className="border p-1">
                <Form.Item
                  rules={[
                    {
                ...
                >
                  <DatePicker
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.RbrUuKFSqkZ.disabled
                    }
                  />
                </Form.Item>
                <span style={{ background: "yellow" }}>
                  {store.allDisabled.RbrUuKFSqkZ.warning}
                </span>
              </td>
            </tr>
            <tr>
              ...
              <td className="border p-1">
                ...
                >
                  <InputNumber
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.q7e7FOXKnOf.disabled
                    }
                  />
                </Form.Item>
                <span style={{ background: "yellow" }}>
                  {store.allDisabled.q7e7FOXKnOf.warning}
                </span>
              </td>
              <td className="border p-1">Sex</td>
              <td className="border p-1">
                {optionSets ? (
                  <Form.Item
            ...
            <tr>
              <td className="border p-1">Place of Birth</td>
              <td className="border p-1">
                <Form.Item name="xNCSFrgdUgi" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.xNCSFrgdUgi.disabled
                    }
                  />
                </Form.Item>
              </td>
              <td className="border p-1">Date and time of death</td>
              <td className="border p-1">
                <Form.Item
                  rules={[
                    {
                ...
                >
                  <DatePicker
                    ...
                    disabled={
                      store.viewMode || store.allDisabled.i8rrl8YWxLF.disabled
                    }
                  />
                </Form.Item>
              </td>
        ...
        <table className="my-2 w-full border-collapse px-2">
          <tbody>
            ...
            <tr>
              ...
              <td className="border p-1">
                <ICDField
                  disabled={store.allDisabled.sfpqAeqKeyQ.disabled}
                  next="Ylht9kCLSRW"
                  form={form}
                  field="sfpqAeqKeyQ"
              ...
              <td className="border p-1">
                <Form.Item name="zD0E77W4rFs" className="m-0">
                  <Input
                    ...
                    readOnly={true}
                    disabled={
                      store.viewMode || store.allDisabled.zD0E77W4rFs.disabled
                    }
                  />
                </Form.Item>
              </td>
              <td className="border p-1">
                <Form.Item name="k9xdBQzYMXo" className="m-0">
                  <Input
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.k9xdBQzYMXo.disabled
                    }
                  />
                </Form.Item>
              </td>
              ...
              <td className="border p-1">
                <Form.Item name="WkXxkKEJLsg" className="m-0">
                  <InputNumber
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.WkXxkKEJLsg.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              ...
              <td className="border p-1">
                <ICDField
                  next="myydnkmLfhp"
                  disabled={store.allDisabled.zb7uTuBCPrN.disabled}
                  form={form}
                  field="zb7uTuBCPrN"
              ...
              <td className="border p-1">
                <Form.Item name="tuMMQsGtE69" className="m-0">
                  <Input
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.tuMMQsGtE69.disabled
                    }
                  />
                </Form.Item>
              </td>
              <td className="border p-1">
                <Form.Item name="yftBZ5bSEOb" className="m-0">
                  <Input
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.yftBZ5bSEOb.disabled
                    }
                  />
                </Form.Item>
              </td>
              ...
              <td className="border p-1">
                <Form.Item name="fleGy9CvHYh" className="m-0">
                  <InputNumber
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.fleGy9CvHYh.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              ...
              <td className="border p-1">
                <ICDField
                  next="aC64sB86ThG"
                  disabled={store.allDisabled.QGFYJK00ES7.disabled}
                  form={form}
                  field="QGFYJK00ES7"
              ...
              <td className="border p-1">
                <Form.Item name="C8n6hBilwsX" className="m-0">
                  <Input
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.C8n6hBilwsX.disabled
                    }
                  />
                </Form.Item>
              </td>
              <td className="border p-1">
                <Form.Item name="fJUy96o8akn" className="m-0">
                  <Input
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.fJUy96o8akn.disabled
                    }
                  />
                </Form.Item>
              </td>
              ...
              <td className="border p-1">
                <Form.Item name="hO8No9fHVd2" className="m-0">
                  <InputNumber
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.hO8No9fHVd2.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              ...
              <td className="border p-1">
                <ICDField
                  next="cmZrrHfTxW3"
                  disabled={store.allDisabled.CnPGhOcERFF.disabled}
                  form={form}
                  field="CnPGhOcERFF"
              ...
              <td className="border p-1">
                <Form.Item name="IeS8V8Yf40N" className="m-0">
                  <Input
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.IeS8V8Yf40N.disabled
                    }
                  />
                </Form.Item>
              </td>
              <td className="border p-1">
                <Form.Item name="S53kx50gjQn" className="m-0">
                  <Input
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.S53kx50gjQn.disabled
                    }
                  />
                </Form.Item>
              </td>
              ...
              <td className="border p-1">
                <Form.Item name="eCVDO6lt4go" className="m-0">
                  <InputNumber
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.eCVDO6lt4go.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              ...
              <td className="border p-1" colSpan={2}>
                <ICDField
                  next="xeE5TQLvucB"
                  disabled={store.allDisabled.QTKk2Xt8KDu.disabled}
                  form={form}
                  field="QTKk2Xt8KDu"
                  codeField="sJhOdGLD5lj"
                  uriField="L97MrANAav9"
                />
              </td>
              <td className="border p-1" colSpan={1}>
                <Form.Item name="sJhOdGLD5lj" className="m-0">
                  <Input
                    readOnly={true}
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.sJhOdGLD5lj.disabled
                    }
                  />
                </Form.Item>
              </td>
              <td className="border p-1" colSpan={2}>
                <Form.Item name="L97MrANAav9" className="m-0">
                  <Input
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.L97MrANAav9.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              ...
              <td className="border p-1" colSpan={2}>
                <ICDField
                  disabled={store.allDisabled.xeE5TQLvucB.disabled}
                  form={form}
                  field="xeE5TQLvucB"
              ...
              <td className="border p-1" colSpan={1}>
                <Form.Item name="ctbKSNV2cg7" className="m-0">
                  <Input
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.ctbKSNV2cg7.disabled
                    }
                  />
                </Form.Item>
              </td>
              <td className="border p-1" colSpan={2}>
                <Form.Item name="T4uxg60Lalw" className="m-0">
                  <Input
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.T4uxg60Lalw.disabled
                    }
                  />
                </Form.Item>
              </td>
        ...
        <table className="my-2 w-full border-collapse px-2">
          <tbody>
              ...
              <td className="border p-1">
                ...
                >
                  <DatePicker
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.j5TIQx3gHyF.disabled
                    }
                  />
                </Form.Item>
              </td>
              ...
              <td className="border p-1">
                <Form.Item name="JhHwdQ337nn" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.JhHwdQ337nn.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              <td className="border p-1">Was an autopsy requested?</td>
              <td className="border p-1">
                {optionSets ? (
        ...
        <table className="my-2 w-full border-collapse px-2">
          <tbody>
            ...
            <tr>
              <td className="border p-1">Disease</td>
              <td className="border p-1">
                <Form.Item
                  name="FhHPxY16vet"
                  className="m-0"
                ...
                >
                  <Checkbox
                    disabled={
                      store.viewMode || store.allDisabled.FhHPxY16vet.disabled
                    }
                  >
                    Yes
                  </Checkbox>
              ...
              <td className="border p-1">Assault</td>
              <td className="border p-1">
                <Form.Item
                  name="KsGOxFyzIs1"
                  className="m-0"
                ...
                >
                  <Checkbox
                    disabled={
                      store.viewMode || store.allDisabled.KsGOxFyzIs1.disabled
                    }
                  >
                    Yes
                  </Checkbox>
              ...
              <td className="border p-1">Could not be determined</td>
              <td className="border p-1">
                <Form.Item
                  name="b4yPk98om7e"
                  className="m-0"
                ...
                >
                  <Checkbox
                    disabled={
                      store.viewMode || store.allDisabled.b4yPk98om7e.disabled
                    }
                  >
                    Yes
                  </Checkbox>
            ...
            <tr>
              <td className="border p-1">Accident</td>
              <td className="border p-1">
                <Form.Item
                  name="gNM2Yhypydx"
                  className="m-0"
                ...
                >
                  <Checkbox
                    disabled={
                      store.viewMode || store.allDisabled.gNM2Yhypydx.disabled
                    }
                  >
                    Yes
                  </Checkbox>
              ...
              <td className="border p-1">Legal intervention</td>
              <td className="border p-1">
                <Form.Item
                  name="tYH7drlbNya"
                  className="m-0"
                ...
                >
                  <Checkbox
                    disabled={
                      store.viewMode || store.allDisabled.tYH7drlbNya.disabled
                    }
                  >
                    Yes
                  </Checkbox>
              ...
              <td className="border p-1">Pending investigation</td>
              <td className="border p-1">
                <Form.Item
                  name="fQWuywOaoN2"
                  className="m-0"
                ...
                >
                  <Checkbox
                    disabled={
                      store.viewMode || store.allDisabled.fQWuywOaoN2.disabled
                    }
                  >
                    Yes
                  </Checkbox>
            ...
            <tr>
              <td className="border p-1">Intentional self-harm</td>
              <td className="border p-1">
                <Form.Item
                  name="wX3i3gkTG4m"
                  className="m-0"
                ...
                >
                  <Checkbox
                    disabled={
                      store.viewMode || store.allDisabled.wX3i3gkTG4m.disabled
                    }
                  >
                    Yes
                  </Checkbox>
              ...
              <td className="border p-1">War</td>
              <td className="border p-1">
                <Form.Item
                  name="xDMX2CJ4Xw3"
                  className="m-0"
                ...
                >
                  <Checkbox
                    disabled={
                      store.viewMode || store.allDisabled.xDMX2CJ4Xw3.disabled
                    }
                  >
                    Yes
                  </Checkbox>
              ...
              <td className="border p-1">Unknown</td>
              <td className="border p-1">
                <Form.Item
                  name="o1hG9vr0peF"
                  className="m-0"
                ...
                >
                  <Checkbox
                    disabled={
                      store.viewMode || store.allDisabled.o1hG9vr0peF.disabled
                    }
                  >
                    Yes
                  </Checkbox>
            ...
            <tr>
              ...
              <td className="border p-1">
                ...
                >
                  <Checkbox
                    disabled={
                      store.viewMode || store.allDisabled.AZSlwlRAFig.disabled
                    }
                  >
                    Yes
                  </Checkbox>
              ...
              <td className="border p-1">Date of injury</td>
              <td className="border p-1" colSpan={2}>
                <Form.Item
                  name="U18Tnfz9EKd"
                  className="m-0"
                ...
                >
                  <DatePicker
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.U18Tnfz9EKd.disabled
                    }
                  />
                </Form.Item>
              </td>
              ...
              <td className="border p-1" colSpan={3}>
                <Form.Item name="DKlOhZJOCrX" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.DKlOhZJOCrX.disabled
                    }
                  />
                </Form.Item>
              </td>
              ...
              <td className="border p-1" colSpan={3}>
                <Form.Item name="kGIDD5xIeLC" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.kGIDD5xIeLC.disabled
                    }
                  />
                </Form.Item>
              </td>
        ...
        <table className="my-2 w-full border-collapse px-2">
          <tbody>
            ...
            <tr>
              ...
              <td className="border p-1">
                <Form.Item name="jf9TogeSZpk" className="m-0">
                  <InputNumber
                    max={24}
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.jf9TogeSZpk.disabled
                    }
                  />
                </Form.Item>
              </td>
              <td className="border p-1">Birth weight (in grams)</td>
              <td className="border p-1">
                <Form.Item name="xAWYJtQsg8M" className="m-0">
                  <InputNumber
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.xAWYJtQsg8M.disabled
                    }
                  />
                </Form.Item>
              ...
              <td className="border p-1">
                <Form.Item name="lQ1Byr04JTx" className="m-0">
                  <InputNumber
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.lQ1Byr04JTx.disabled
                    }
                  />
                </Form.Item>
                ...
                form.getFieldValue("lQ1Byr04JTx") > 55 ? (
                  <span style={{ background: "yellow" }}>
                    completed weeks should be between 10 and 54 weeks
                  </span>
                ) : null}
              </td>
              <td className="border p-1">Age of mother (years)</td>
              <td className="border p-1">
                <Form.Item name="DdfDMFW4EJ9" className="m-0">
                  <InputNumber
                    ...
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.DdfDMFW4EJ9.disabled
                    }
                  />
                </Form.Item>
              ...
              <td className="border p-1" colSpan={2}>
                <Form.Item name="GFVhltTCG8b" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.GFVhltTCG8b.disabled
                    }
                  />
                </Form.Item>
              </td>
        ...
        <table className="my-2 w-full border-collapse px-2">
          <tbody>
            ...
            <tr>
              <td className="border p-1">At what point?</td>
              <td className="border p-1">
                <Form.Item name="KpfvNQSsWIw" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.KpfvNQSsWIw.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              <td className="border p-1">Referred from (level of care)</td>
              <td className="border p-1">
                <Form.Item name="RJhbkjYrODG" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.RJhbkjYrODG.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              <td className="border p-1">Parity</td>
              <td className="border p-1">
                <Form.Item name="ymyLrfEcYkD" className="m-0">
                  <Input
                    size="large"
                    disabled={
                      store.viewMode || store.allDisabled.ymyLrfEcYkD.disabled
                    }
                  />
                </Form.Item>
              </td>
            ...
            <tr>
              <td className="border p-1">Mode of delivery</td>
              <td className="border p-1">
                {optionSets ? (
            ...
            <tr>
              <td className="border p-1">Place of delivery</td>
              <td className="border p-1">
                {optionSets ? (
            ...
            <tr>
              <td className="border p-1">Delivered by skilled attendant</td>
              <td className="border p-1">
                {optionSets ? (
